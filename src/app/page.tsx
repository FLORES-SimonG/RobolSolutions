    ...
    <>
      ...
      <section className="w-full text-black">
        <div className="max-w-8xl mx-auto inline-block items-center p-3 pt-0 lg:flex lg:flex-wrap lg:pt-4">
          ...
          <Image src="/placeholder.png" alt="image" height={200} width={200}    className="
                lg:w-5/7
                mb-40
                hidden
                w-5/6
          ...
          <div className="my-20 inline-block w-full flex-col lg:mt-0 lg:hidden lg:w-2/5">
            <Image src="/placeholder.png" alt="image" height={200} width={200}/>
          </div>
        </div>
              ...
              >
                <div className="hidden items-center justify-center lg:inline-block">
                  <Image
                    src="/segment.png"
                    alt="Segment"
                    className="block h-24 object-contain" width={200} height={200}
